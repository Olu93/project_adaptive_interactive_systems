...
\begin{figure}[H]
    \centering
    \subfloat[\centering]{{\includegraphics[width=0.3\textwidth]{paper/imgs/hifi_prototypes/profile.png} }}%
    \qquad
    \subfloat[\centering]{{\includegraphics[width=0.3\textwidth]{paper/imgs/hifi_prototypes/trip_settings.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering]{{\includegraphics[width=0.25\textwidth]{paper/imgs/hifi_prototypes/content_adaptation.png} }}%
    \qquad
    \subfloat[\centering]{{\includegraphics[width=0.25\textwidth]{paper/imgs/hifi_prototypes/beach.png}}}%
...
%After agreeing in an offline discussion that they do not want to go there, Sara has to pick a new starting point for their trip. Another activity that she would like to do is going to the beach of Rotterdam. Since it happens to be an extremely warm day for this time of the year in the Netherlands, she picks Hoek van Holland from her suggested list. This time, everyone likes the idea and they decide to go there, even if it takes approximately 40 minutes by means of transport to get there from the central train station. Sara taps on the directions button and the item is selected and greyed out of the list.\\
...
\begin{figure}[H]
    ...
    \subfloat[\centering]{{\includegraphics[width=0.25\textwidth]{paper/imgs/hifi_prototypes/beach.png} }}%
    \qquad
    \subfloat[\centering]{{\includegraphics[width=0.25\textwidth]{paper/imgs/hifi_prototypes/cinema.png} }}%
